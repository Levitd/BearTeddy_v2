...
const StyledBurgerLink = ({ children, styleType = "default", className, show, ...rest }) => {
    function getLinkStyle(style) {
        switch (style) {
            ...
            default:
                return "hover:text-sky-500 transition-colors duration-200 px-4 py-0 text-slate-500";
        }
    }
...
export default StyledBurgerLink;