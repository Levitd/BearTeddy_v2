...
import { getViewedProduct, setViewedProducts, setViewedProductsFromServer } from "../services/localStorage.service";
...
export const updateViewedProducts = (data, _id, activeProductId) => async (dispatch, getState) => {
    ...
    if (_id) {
        dispatch(updateViewedProductsServer({ _id, listViewedProducts }));
    }
    return;
};
...
export const getViewedIdList = () => (state) => state.viewed.entities;
